...
def main():
    ...
    parser.add_argument('--config-file', '-cf2', type=str, 
                       default='/home/xxx/projects/mol_opt/mol-ofo/mol_evo/dataset/data/qm9-evo-pairs-step-1-with-properties-pct-config.yaml',
...
def run4debug():
    ...
    class Args:
        def __init__(self):
            self.model_path = "/home/xxx/projects/mol_opt/mol-ofo/mol_evo/output/v0/MoleculeEvolutionVisnetLinearPredictor/train-20251123_192921-lumo_change-120000-200/last.pth"
            self.model_dir = "/home/xxx/projects/mol_opt/mol-ofo/mol_evo/output/v0/MoleculeEvolutionVisnetLinearPredictor/train-20251123_192921-lumo_change-120000-200"
            self.smiles_from = "CC"
            self.smiles_to = "CO"
            self.atom_symbol = "0"
            ...
            self.config_file = "/home/xxx/projects/mol_opt/mol-ofo/mol_evo/dataset/data/qm9-evo-pairs-step-1-with-properties-pct-config.yaml"   # UPDATE 这个或许得跟 model 本身的训练关联起来，然后根据 model-path 方便的链接；
