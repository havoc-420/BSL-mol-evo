...
# -*- coding: utf-8 -*-
"""
基于ViSNet和Transformer的分子进化预测器 (ViSNet-Transformer-Linear版本)
...
@register_model(display_name="ViSNet-Transformer-Linear 模型", save_dir_name="visnet_transformer_linear")
class MoleculeEvolutionVisNetTransformerLinearPredictor(nn.Module):
    """
    基于ViSNet和Transformer的分子进化预测器 (ViSNet-Transformer-Linear版本)
    ...
    def __init__(self, node_feature_dim: int = 11, edge_feature_dim: int = 15,
        ...
        """
        super(MoleculeEvolutionVisNetTransformerLinearPredictor, self).__init__()
