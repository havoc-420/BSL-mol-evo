...
class VisNetMoleculeFeatureExtractor(nn.Module):
    """
    VisNet分子特征提取器
    ...
    def __init__(self, node_feature_dim: int = 64, hidden_dims: list = None):
        """
        初始化特征提取器
        ...
        """
        super(VisNetMoleculeFeatureExtractor, self).__init__()
